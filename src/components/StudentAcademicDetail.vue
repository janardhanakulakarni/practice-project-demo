<template>
    <div>
        ...
        <v-btn @click="goToContactDetails" large  style="background: brown" class="submit-btn-color mr-5">Previous</v-btn>
        <v-btn @click="compltedThirdStep" large style="background: #85B09A" class="submit-btn-color">Continue</v-btn>
        </div>
    </div>
</template>
<style scoped>
