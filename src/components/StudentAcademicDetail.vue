<template>
    <div>
        ...
        <v-btn @click="goToContactDetails" large  color="previous" class="submit-btn-color mr-5">Previous</v-btn>
        <v-btn @click="compltedThirdStep" large color="primary" class="submit-btn-color">Continue</v-btn>
        </div>
    </div>
</template>
<style scoped>
